...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "christien-starter"
  ...
  #   chef.chef_server_url = "https://ip-10-69-81-90.ec2.internal/organizations/oris4"
  #   chef.validation_client_name = "oris4-validator"
  #   chef.validation_key_path = ".chef/oris4-validator.pem"
  # end
end
